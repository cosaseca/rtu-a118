...
static const struct display_panel azm335x_lcd_cape_disp_panel = {
	WVGA,
	16,
	16,
	COLOR_ACTIVE,
...
static struct lcd_ctrl_config azm335xd_lcd_cape_cfg = {
	&azm335x_lcd_cape_disp_panel,
	.ac_bias                = 255,
	.ac_bias_intrpt         = 0,
	.dma_burst_sz           = 16,
	.bpp                    = 16,
...
struct da8xx_lcdc_platform_data AUO_A070VW04_pdata = {
	.manu_name		= "AUO",
	.controller_data	= &azm335xd_lcd_cape_cfg,
	.type			= "AUO_A070VW04",
};

struct da8xx_lcdc_platform_data AT070TN92_pdata = {
	.manu_name		= "LNNOLUX",
	.controller_data	= &azm335xd_lcd_cape_cfg,
	.type			= "AT070TN92",
};
...
static struct mfd_tscadc_board tscadc = {
	...
	.adc_init = &am335x_adc_data, //add by ygz
};
...
static u8 am335x_iis_serializer_direction0[] = {
	TX_MODE,	    RX_MODE,        INACTIVE_MODE,	INACTIVE_MODE,      //AXR0 as TX, AXR1 as RX
...
/* Module pin mux for spi1 for azm335x*/
static struct pinmux_config azm335x_spi1_pin_mux[] = {
// by wzg del 20141028
//	{"mii1_crs.mcasp1_aclkx", OMAP_MUX_MODE2 | AM33XX_PULL_ENBL | AM33XX_INPUT_EN},
//	{"mii1_rxerr.mcasp1_fsx", OMAP_MUX_MODE2 | AM33XX_PULL_ENBL | AM33XX_PULL_UP | AM33XX_INPUT_EN},
//	{"mii1_col.mcasp1_axr2", OMAP_MUX_MODE2 | AM33XX_PULL_ENBL | AM33XX_PULL_UP | AM33XX_INPUT_EN},
	{NULL, 0},
};
...
static struct pinmux_config uart2_pin_mux[] = {
	...
	{"spi0_d0.uart2_txd", OMAP_MUX_MODE1 | AM33XX_PULL_UP |
						AM33XX_PULL_DISA |
						AM33XX_SLEWCTRL_SLOW},
	{"spi0_cs0.gpio0_5", OMAP_MUX_MODE7 | AM33XX_PIN_OUTPUT}, //modify by ygz
	{NULL, 0},
};
...
/* pinmux for gpio led/relay/watchdog/RS485dir/ctr
*   by wzg add 20141030	
*/
static struct pinmux_config gpio_out_mux[] = {
	...
	{"mii1_txd0.gpio0_28", OMAP_MUX_MODE7 | AM33XX_PIN_OUTPUT},
	...
	{"mii1_col.gpio3_0", OMAP_MUX_MODE7 | AM33XX_PIN_OUTPUT},
	{"mii1_crs.gpio3_1", OMAP_MUX_MODE7 | AM33XX_PIN_OUTPUT},
	{"mii1_rxerr.gpio3_2", OMAP_MUX_MODE7 | AM33XX_PIN_OUTPUT},
...
*   by wzg add 20141030	
*/
static struct pinmux_config gpio_in_mux[] = {
...
static void lcdc_init(int evm_id, int profile)
{
	...
	case EVM_SK:
		...
		break;
	case GEN_AZM335X_EVM:
		//lcdc_pdata = &AUO_A070VW04_pdata;
		lcdc_pdata = &AT070TN92_pdata;	
		break;
	default:
...
//struct platform_device ti_adc_device = {
//		.name = "tiadc",
//		.id = -1,
//		.dev = {
//				.platform_data = &am335x_adc_data,
//		},
//		.num_resources = 0,
//		.resource = NULL,
//};
...
{
//	pr_info("before --> am33xx_register_mfd_tscadc\n");
////	platform_device_add(&ti_adc_device);
////	platform_device_register();
////	platform_add_devices(&ti_adc_device, 1);
//	pr_info("after --> am33xx_register_mfd_tscadc\n");
	int err;
...
static void gpio_in_out_init(int evm_id, int profile)
{
	setup_pin_mux(gpio_out_mux);
	setup_pin_mux(gpio_in_mux);
}
...
static void spi1_init(int evm_id, int profile)
{
	switch (evm_id) {
	case GEN_AZM335X_EVM:
		setup_pin_mux(azm335x_spi1_pin_mux);
		break;
	default:
...
/* General Purpose EVM */
//defined but not used 	by wzg comment
...
static struct evm_dev_cfg azm335x_dev_cfg[] = {
//	{lcdc_init,         DEV_ON_BASEBOARD, PROFILE_ALL},	//by wzg 20141021
	{usb0_init,	        DEV_ON_BASEBOARD, PROFILE_ALL},
	{usb1_init,	        DEV_ON_BASEBOARD, PROFILE_ALL},
	{mmc0_init,	        DEV_ON_BASEBOARD, PROFILE_ALL},
//	{i2c1_init,	        DEV_ON_BASEBOARD, PROFILE_ALL},
	{i2c2_init,	        DEV_ON_BASEBOARD, PROFILE_ALL},	//by wzg add 20141029
	{evm_nand_init,     DEV_ON_BASEBOARD, PROFILE_ALL},
	{uart1_init,    	DEV_ON_BASEBOARD, PROFILE_ALL},
	{uart2_init,    	DEV_ON_BASEBOARD, PROFILE_ALL},
	{uart3_init,    	DEV_ON_BASEBOARD, PROFILE_ALL},	//by wzg add 20141021
	{uart4_init,    	DEV_ON_BASEBOARD, PROFILE_ALL},
	{uart5_init,    	DEV_ON_BASEBOARD, PROFILE_ALL},	//by wzg add 20141021
//	{rgmii1_init,       DEV_ON_BASEBOARD, PROFILE_ALL},	
	{rgmii2_init,       DEV_ON_BASEBOARD, PROFILE_ALL},
//	{mcasp0_init,       DEV_ON_BASEBOARD, PROFILE_ALL},	
	{mfd_tscadc_init,	DEV_ON_BASEBOARD, PROFILE_ALL},	//by wzg del 20141021
//
	//by wzg add 20141030
	{gpio_in_out_init,       DEV_ON_BASEBOARD, PROFILE_ALL},
...
static void azm335x_setup(void)
{
	/* fill MAC address */
    am335x_mac_addr[0][0]=0x20;
    am335x_mac_addr[0][1]=0x10;
    am335x_mac_addr[0][2]=0x40;
    am335x_mac_addr[0][3]=0x30;
    am335x_mac_addr[0][4]=0x12;
    am335x_mac_addr[0][5]=0x13;
    am335x_mac_addr[1][0]=0x20;
    am335x_mac_addr[1][1]=0x10;
    am335x_mac_addr[1][2]=0x40;
    am335x_mac_addr[1][3]=0x30;
    am335x_mac_addr[1][4]=0x12;
    am335x_mac_addr[1][5]=0x14;

	pr_info("The board is a AZM335x.\n");

	/* AZM335x has Micro-SD slot which doesn't have Write Protect pin*/
	am335x_mmc[0].gpio_wp = -EINVAL;

	_configure_device(GEN_AZM335X_EVM, azm335x_dev_cfg, PROFILE_NONE);
    ...
    //reg =omap_ctrl_readl(TI81XX_CONTROL_USB_CTRL1);
    //omap_ctrl_writel(reg&(~(1<<19)), TI81XX_CONTROL_USB_CTRL1);
}
...
static void __init am335x_evm_init(void)
{
	...
	clkout2_enable();
	am335x_evm_i2c_init();
    pr_info("before azm335x_setup\n");
    azm335x_setup();
    pr_info("after azm335x_setup\n");
	omap_sdrc_init(NULL, NULL);
	pr_info("after omap_sdrc_init\n");
	usb_musb_init(&musb_board_data);
	pr_info("after usb_musb_init\n");
