...
table_crc_hi = [0x00, 0xC1, 0x81, 0x40, 0x01, 0xC0,
...
table_crc_lo = [0x00, 0xC0, 0xC1, 0x01, 0xC3, 0x03,
...
def crc16(buffer):
    ...
    for v in buffer:
        i = crc_hi ^ v
        crc_hi = (crc_lo ^ table_crc_hi[i]) & 0xFF
        crc_lo = table_crc_lo[i] & 0xFF

    return (crc_hi<<8 | crc_lo)
    
if __name__ == "__main__":
    a = crc16([0x03, 0x03, 0x00, 0x00, 0x00, 0x10])
    print hex(a)